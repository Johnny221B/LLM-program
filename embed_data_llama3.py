...
weight_name = 'linear_probe_weights_data_modify.pth'
embedding_path = '/home/jingxuan/linear_probing/embeddings_data_llama3/'
code_name = 'llama3-data-p25-l13-linear2'
lambda_l1 = 1e-3
...
linear_probe = LinearProbe(4096, 128).to(device)  # Assuming embedding size of 4096
optimizer = torch.optim.AdamW(linear_probe.parameters(), lr=learning_rate, weight_decay=1e-3)
